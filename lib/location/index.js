...
module.exports = createRouter({
  ...
  router.get('/created_by/:id', authenticationRequired, (req, res) => {
    Location
      .find()
  ...
  router.put('/:id', authenticationRequired, adminRequired, byId, (req, res) => {
  ...
  router.get('/:id/analysis', authenticationRequired, adminRequired, (req, res) => {
