...
module.exports = createRouter({
  ...
  router.get('/created_by', stormpath.authenticationRequired, (req, res) => {
    Location
      .find()
  ...
  router.get('/:id/analysis', stormpath.authenticationRequired, stormpath.groupsRequired(['admins']), (req, res) => {
