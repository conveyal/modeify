...
function filterExcessiveTransitOptions (opts) {
  ...
  opts = opts.filter(function (o) {
    ...
    if (o.access && o.access.length === 1 && o.access[0].mode === 'BICYCLE') {
      bikeToTransitOpts.enq(o)
      return false
    } else if (o.access && o.access.length === 1 && o.access[0].mode === 'WALK') {
  ...
  var count = 0
  var max = 3
  while (bikeToTransitOpts.size() > 0 && count < max) {
