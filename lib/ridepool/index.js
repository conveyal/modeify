...
module.exports = createRouter({
  ...
  router.post('/', stormpath.authenticationRequired, (req, res) => {
    const data = {
  ...
  router.post('/batch', stormpath.authenticationRequired, function (req, res) {
  ...
  router.delete('/:id', stormpath.authenticationRequired, byId, (req, res) => {
    req.ridepool
      .remove()
      .then(() => {
        res.status(204).end()
