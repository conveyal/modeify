...
if (env === 'development') {
  app
    ...
    .use('/assets', require('serve-static')(__dirname + '/../assets', { setHeaders: setStaticHeaders }))
    .use(require('serve-favicon')(__dirname + '/../assets/images/favicon.png'))
...
function setStaticHeaders(res, path, stat) {
  if (/.css|.js$/.test(path) && env !== 'development') {
