...
var templates = {
  manager: handlebars.compile(read(__dirname + '/../client/manager.html', { encoding: 'utf8' })),
  planner: handlebars.compile(read(__dirname + '/../client/planner.html', { encoding: 'utf8' }))
}
var version = null
