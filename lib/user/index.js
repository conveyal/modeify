...
app.get('/:id', authenticationRequired, adminRequired, function (req, res) {
...
app.get('/:id/groups', authenticationRequired, adminRequired, function (req, res) {
...
app.get('/:id/add-to-group', authenticationRequired, adminRequired, function (req, res) {
...
app.get('/:id/remove-from-group', authenticationRequired, adminRequired, function (req, res) {
...
app.put('/:id', authenticationRequired, adminRequired, function (req, res) {
...
app.delete('/:id', authenticationRequired, adminRequired, function (req, res) {
