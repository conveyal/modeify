...
Remotes.prototype.check = regeneratorRuntime.mark(function callee$0$0(remotes, name, reference) {
  var length, instances, i;

  return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
    case 0:
      length = this.remotes.length;
    ...
    case 3:
      ...
      instances = remotes.map(function (name) {
    ...
    case 8:
      ...
      return context$1$0.delegateYield(instances[i].isValid(remotes, name, reference), "t0", 10);
    case 10:
      if (!context$1$0.t0) {
        context$1$0.next = 12;
        break;
      ...
      return context$1$0.abrupt("return", instances[i]);
    case 12:
      i++;
      context$1$0.next = 8;
      break;
...
Remotes.prototype.resolve = regeneratorRuntime.mark(function callee$0$1(remotes, name, reference) {
  var length, instances, i;
  ...
  return regeneratorRuntime.wrap(function callee$0$1$(context$1$0) {
    ...
    case 8:
      ...
      return context$1$0.delegateYield(instances[i].resolve(remotes, name, reference), "t1", 10);
    case 10:
      if (!context$1$0.t1) {
        context$1$0.next = 12;
        break;
