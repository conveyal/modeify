...
GitHub.prototype._checkRedirect = regeneratorRuntime.mark(function callee$0$0(repo) {
  ...
  return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
    ...
    case 0:
      ...
      uri = baseUrl + repo;
      return context$1$0.delegateYield(this.request(uri, {string: true, method: 'HEAD', redirects: 0}), "t0", 4);
    case 4:
      res = context$1$0.t0;
...
GitHub.prototype._versions = regeneratorRuntime.mark(function callee$0$1(repo) {
  ...
  return regeneratorRuntime.wrap(function callee$0$1$(context$1$0) {
    ...
    case 0:
      ...
      debug('GET "%s"', uri);
      API_COUNTER++;
      return context$1$0.delegateYield(this.request(uri, true), "t1", 4);
    case 4:
      res = context$1$0.t1;
      ...
      return context$1$0.delegateYield(this._checkRedirect(repo), "t2", 7);
    case 7:
      renamed = context$1$0.t2;
      ...
      return context$1$0.delegateYield(this._versions(renamed), "t3", 10);
    case 10:
...
GitHub.prototype._json = regeneratorRuntime.mark(function callee$0$2(repo, ref) {
  ...
  return regeneratorRuntime.wrap(function callee$0$2$(context$1$0) {
    ...
    case 5:
      ...
      debug('GET "%s"', uri);
      context$1$0.prev = 8;
      return context$1$0.delegateYield(this.request(uri, true), "t4", 10);
    case 10:
      res = context$1$0.t4;
      context$1$0.next = 17;
      break;
    case 13:
      context$1$0.prev = 13;
      context$1$0.t5 = context$1$0.catch(8);
      debug("error when GETing \"%s\": \"%s", uri, context$1$0.t5.message);
...
GitHub.prototype._tree = regeneratorRuntime.mark(function callee$0$3(repo, ref) {
  var uri, res, renamed, err;
  ...
  return regeneratorRuntime.wrap(function callee$0$3$(context$1$0) {
    ...
    case 0:
      ...
      debug('GET "%s"', uri);
      API_COUNTER++;
      return context$1$0.delegateYield(this.request(uri, true), "t6", 4);
    case 4:
      res = context$1$0.t6;
    ...
    case 7:
      ...
      return context$1$0.delegateYield(this._checkRedirect(repo), "t7", 9);
    case 9:
      renamed = context$1$0.t7;
      ...
      return context$1$0.delegateYield(this._tree(renamed), "t8", 12);
    case 12:
