...
var read = regeneratorRuntime.mark(function read(filename) {
  var string;

  return regeneratorRuntime.wrap(function read$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
    case 0:
      context$1$0.next = 2;
      return fs.readFile.bind(null, filename, 'utf8');
    case 2:
      string = context$1$0.sent;
      return context$1$0.abrupt("return", JSON.parse(string));
    case 4:
    case "end":
...
module.exports = regeneratorRuntime.mark(function callee$0$0(tree, options) {
  var verbose, development, fns, start, remote;
  ...
  return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
    ...
    case 0:
      ...
      remote = remotes.local(options);

      flatten(tree)
      .filter(isLocal)
      .forEach(function (node) { fns.push(regeneratorRuntime.mark(function callee$2$0() {
        var component, json, fns, updates, push;

        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
          case 0:
            push = function push(deps, dev) {
              Object.keys(deps).forEach(function (name) {
                var version = deps[name];
                if (!isRange(version)) return;

                fns.push(regeneratorRuntime.mark(function callee$5$0() {
                  var versions, latest;

                  return regeneratorRuntime.wrap(function callee$5$0$(context$6$0) {
                    while (1) switch (context$6$0.prev = context$6$0.next) {
                    case 0:
                      return context$6$0.delegateYield(remote.versions(name), "t0", 1);
                    case 1:
                      versions = context$6$0.t0;
                    ...
                    case 4:
                      latest = semver.maxSatisfying(versions, version);
          ...
          case 10:
            return context$3$0.delegateYield(read(node.filename), "t1", 11);
          case 11:
            component = context$3$0.t1;
            updates.forEach(call);

            context$3$0.next = 15;
            return write.bind(null, node.filename, JSON.stringify(component, null, 2));
          case 15:
          case "end":
