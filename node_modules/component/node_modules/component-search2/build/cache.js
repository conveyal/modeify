...
var cache = regeneratorRuntime.mark(function cache(options) {
  var maxage, age;

  return regeneratorRuntime.wrap(function cache$(context$1$0) {
    ...
    case 0:
      ...
      return context$1$0.delegateYield(cache.update(options), "t0", 3);
    case 3:
    ...
    case 4:
      ...
      if (!(!age || Date.now() - age > maxage)) {
        context$1$0.next = 9;
        break;
      }

      return context$1$0.delegateYield(cache.update(options), "t1", 8);
    case 8:
...
cache.update = regeneratorRuntime.mark(function callee$0$0(options) {
  var verbose, res, stats;
  ...
  return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
    ...
    case 9:
      return context$1$0.delegateYield(request(uri, filename), "t3", 10);
    case 10:
      res = context$1$0.t3;
