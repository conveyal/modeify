...
var search = regeneratorRuntime.mark(function search(options) {
  var filters, components;

  return regeneratorRuntime.wrap(function search$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
    case 0:
      return context$1$0.delegateYield(cache(options), "t0", 1);
    case 1:
      filters = [];
      ...
      return toArray(fs.createReadStream(cache.filename)
    ...
    case 7:
      components = context$1$0.sent;

      return context$1$0.abrupt("return", components
