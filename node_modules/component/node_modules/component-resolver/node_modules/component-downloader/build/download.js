...
Downloader.prototype.download = wrapGenerator.mark(function(remotes, repo, ref, archive) {
  var folder, start, remote, json, hasGlobs, fileCount, elapsed, onexit;
  ...
  return wrapGenerator(function($ctx0) {
    ...
    case 0:
      ...
      return $ctx0.delegateYield(this.exists(folder), "t0", 5);
    case 5:
      if (!$ctx0.t0) {
        $ctx0.next = 7;
        break;
      ...
      return $ctx0.abrupt("return", debug('"%s" exists, skipping downloading.', folder));
    case 7:
      start = Date.now();
      return $ctx0.delegateYield(this.resolve(remotes, repo, ref), "t1", 9);
    case 9:
      remote = $ctx0.t1;
      debug('resolved %s@%s to %s', repo, ref, remote.name);
      return $ctx0.delegateYield(remote.json(repo, ref), "t2", 12);
    case 12:
      json = $ctx0.t2;
      if (typeof archive !== 'boolean') archive = this.archive;
      hasGlobs = this.hasGlobs(json);
      ...
      return $ctx0.delegateYield(this._byArchive(remote, repo, ref), "t3", 22);
    case 22:
      $ctx0.next = 25;
      break;
    case 24:
      return $ctx0.delegateYield(this._byFields(remote, repo, ref), "t4", 25);
    case 25:
      $ctx0.next = 32;
      break;
    case 27:
      $ctx0.prev = 27;
      $ctx0.t5 = $ctx0.catch(19);
      $ctx0.next = 31;
      return rimraf.bind(null, folder);
    case 31:
      throw $ctx0.t5;
    case 32:
