...
function suggestAmigo(text, callback) {
    ...
    get(url_search_amigo + '?token='+config.realtime_access_token()+'&boundary.rect.min_lat=36.155617833819&boundary.rect.min_lon=-123.607177734375&boundary.rect.max_lat=38.826870521381&boundary.rect.max_lon=-120.701293945312&sources=osm,oa&text=' + text,
